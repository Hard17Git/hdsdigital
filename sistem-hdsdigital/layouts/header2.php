                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="javascript: void(0);" class="logo logo-dark">
                            <span class="logo-lg">
                                <img src="../../assets/images/hdsdigital/hds-dark.png" alt="" height="40px">
                            </span>
                        </a>

                        <a href="javascript: void(0);" class="logo logo-light">
                            <span class="logo-lg">
                                <img src="../../assets/images/hdsdigital/hds-light.png" alt="" height="40px">
                            </span>
                        </a>
                    </div>
                    ...
                    <form class="app-search d-none d-md-block">
                        <div class="align-items-left">
                            <h6><b><?= date('d F Y') ?></b></h6>
                            <h6 id="jam"><b>00:00:00</b></h6>
                        </div>
                    </form>
                </div>
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Hardian Maulana</span>
                                    <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">HDS Digital</span>
                                </span>
                            </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">Welcome Hardian!</h6>
