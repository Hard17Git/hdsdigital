...
<div class="customizer-setting d-none d-md-block">
    <a href="https://wa.me/6281395408423/">
        <div class="btn-success btn-rounded shadow-lg btn btn-icon btn-lg p-2">
            <i class='mdi mdi-spin mdi-whatsapp fs-22 text-white'></i>
        </div>
    </a>
</div>
