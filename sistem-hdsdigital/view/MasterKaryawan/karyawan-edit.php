...
<head>
    ...
    <title>Edit Data Karyawan | Sistem HDS Digital</title>
                                            ...
                                            <div class="row gy-3">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <div class="profile-user position-relative d-inline-block mx-auto">
                                                                <img src="../../assets/images/karyawan/hardian.png" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="kode_karyawan" placeholder="23031703980001">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="nama_karyawan" class="form-label">Nama Karyawan<span class="text-danger fs-16">*</span></label>
                                                        <input type="text" class="form-control" id="nama_karyawan" placeholder="Hardian Maulana">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <select class="form-select" aria-label="Default select example">
                                                            <option class="text-muted" selected>Laki-laki</option>
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="nomer_handphone" placeholder="08156411130">
                                                    </div>
                                                </div>
                                                <div align="center">
                                                    <div>
                                                        <div class="col-xxl-6 col-md-11">
                                                            <div class="form-check form-check-success">
                                                                <input class="form-check-input fs-16" type="checkbox" id="" checked> &nbsp;
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <select class="form-select" aria-label="Default select example">
                                                            <option class="text-muted" selected >Aktif</option>
                                            ...
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <div class="form-icon right">
                                                            <input type="email" class="form-control form-control-icon" id="email" placeholder="hardian.maulana1738@gmail.com">
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <textarea class="form-control" id="alamat" rows="3" placeholder="Karyamulya, Kesambi, Kota Cirebon"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                                                        <input type="text" class="form-control" id="tempat_lahir" placeholder="Kuningan">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                                                        <input type="text" class="form-control" id="tanggal_lahir" placeholder="17 Maret 1998">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <select class="form-select" aria-label="Default select example">
                                                            <option class="text-muted" selected >Islam</option>
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <select class="form-select" aria-label="Default select example">
                                                            <option class="text-muted" selected >Belum Menikah</option>
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="tanggal_bergabung" placeholder="01 Maret 2023">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="masa_kerja" class="form-label">Masa Kerja</label>
                                                        <input type="text" class="form-control" id="masa_kerja" placeholder="7 Bulan 13 Hari" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
