...
<head>
    ...
    <title>Edit Daftar Harga | Sistem HDS Digital</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Edit Daftar Harga</h4>
                                            ...
                                            <div class="row gy-3">
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="kode_produk" placeholder="AD0001">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="nama_produk" class="form-label">Nama Produk<span class="text-danger fs-16">*</span></label>
                                                        <input type="text" class="form-control" id="nama_produk" placeholder="Spanduk">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <select class="form-select" aria-label="Default select example">
                                                            <option class="text-muted" selected>Advertising</option>
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="range_harga" placeholder="Mulai dari 25.000 per meter">
                                                    </div>
                                                </div>
