                                            ...
                                            <div class="row gy-3">
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" id="kode_vendor" placeholder="VN001">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="nama_vendor" class="form-label">Nama Vendor<span class="text-danger fs-16">*</span></label>
                                                        <input type="text" class="form-control" id="nama_vendor" placeholder="CV Andhara">
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="nomer_handphone" class="form-label"> Handphone<span class="text-danger fs-16">*</span></label>
                                                        <input type="text" class="form-control" id="nomer_handphone" placeholder="081316210090">
                                                    </div>
                                                </div>
                                                <div align="center">
                                                    <div>
                                                ...
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        ...
                                                        <textarea class="form-control" id="alamat" rows="3" placeholder="Kedawung, Cirebon"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-md-12">
                                                    <div>
                                                        <label for="keterangan" class="form-label">Keterangan<span class="text-danger fs-16">*</span></label>
                                                        <textarea class="form-control" id="alamat" rows="3" placeholder="Kaos dan Jersey"></textarea>
                                                    </div>
                                                </div>
